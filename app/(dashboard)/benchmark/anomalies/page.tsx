...
export default function BenchmarkAnomaliesPage() {
  ...
  }, [selectedOrgId, sites, siteMap, filters.siteId, filters.equipmentId, filters.anomalyType, filters.dateRange]);
  ...
  // Equipment options filtered by selected site
  ...
  const hasActiveFilters = filters.siteId || filters.equipmentId || filters.anomalyType || filters.severity;
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        {hasActiveFilters && (
          <button
            onClick={() => setFilters({ siteId: "", equipmentId: "", anomalyType: "", severity: "", dateRange: "all" })}
