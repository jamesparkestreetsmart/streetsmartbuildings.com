...
import HardwareCatalogPage from "@/components/admin/hardware/HardwareCatalogPage";
...
export default async function HardwareCatalogRoute() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">Hardware Catalog</h1>
        <p className="text-sm text-gray-500">Product reference, purchase orders & vendor registry</p>
      </div>
      <HardwareCatalogPage />
    </div>
  );
